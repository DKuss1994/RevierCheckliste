...
class SecurityObjectControllerTest {
    ...
    private final SecurityObject securityObject = new SecurityObject(1L, "Object A", zone, address, standardConfiguration);
    private final SecurityObject securityObjectB = new SecurityObject(2L, "Object B", zone, address, standardConfiguration);

    @Test
    void shouldCreateSecurityObject() throws Exception {
        when(securityObjectService.create(any(SecurityObject.class))).thenReturn(securityObject);
    ...
    void shouldGetSecurityObjectById() throws Exception {
        when(securityObjectService.findById(1L)).thenReturn(securityObject);
    ...
    void shouldGetAllSecurityObjects() throws Exception {
        when(securityObjectService.findAll()).thenReturn(List.of(securityObject, securityObjectB));
